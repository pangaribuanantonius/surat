...
<?php
                                                ...
                                                $result = mysqli_query($koneksi,"SELECT * FROM tblsuratmasuk join tblopd on tblopd.idopd=tblsuratmasuk.idopd WHERE idbidang=$_SESSION[idbidang] AND iduser=$_SESSION[iduser] AND jabatan='staff'");
            ...
            <form method="post" action="disposisi.php?idsuratmasuk=<?php echo $row['idsuratmasuk'] ?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="iduser">
                  ...
                  $data = mysqli_query($koneksi, "select * from tbluser where jabatan='staff' AND idseksi=$_SESSION[idseksi]");
