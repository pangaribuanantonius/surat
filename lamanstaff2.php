...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <a class="btn btn-sm btn-primary btn-block" href="./upload/file/<?=$row['file']?>"><small>Dokumen</small></a>
     ...
     <a class="btn btn-sm btn-success btn-block" href="#" href="#" data-toggle="modal" data-target="#kekasi<?php echo $row['idbuatsurat'];?>"><small>Disposisi</small></a>
 
    <!-- <a class="btn btn-sm btn-secondary btn-block" href="#"><small>Selesai</small></a> -->
...
<!--update-->
    ...
    <div class="modal fade" id="kekasi<?php echo $row['idbuatsurat'];?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="kekasi.php?idbuatsurat=<?php echo $row['idbuatsurat'] ?>" enctype="multipart/form-data">
