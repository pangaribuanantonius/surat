...
if($_SESSION['iduser']){
  ...
  $iduser = $_POST['iduser'];
      ...
      $tambah=mysqli_query($koneksi,"update tblsuratmasuk set idbidang='$idbidang', iduser='$iduser', jabatan='kabid' where idsuratmasuk='$idsuratmasuk'") or die(mysqli_error($koneksi));
