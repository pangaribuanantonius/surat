...
<?php
                                                ...
                                                $result = mysqli_query($koneksi,"SELECT * FROM tblsuratmasuk join tblopd on tblopd.idopd=tblsuratmasuk.idopd WHERE idbidang=$_SESSION[idbidang] AND jabatan='kabid'");
...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <a class="btn btn-sm btn-success btn-block" href="#" href="#" data-toggle="modal" data-target="#disposisi2<?php echo $row['idsuratmasuk'];?>"><small>Disposisi</small></a>
...
<!--update-->
    ...
    <div class="modal fade" id="disposisi2<?php echo $row['idsuratmasuk'];?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="disposisi2.php?idsuratmasuk=<?php echo $row['idsuratmasuk'] ?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="iduser">
                  ...
                  <option value="<?=$iduser;?>"><?=$jabatan;?></option>
